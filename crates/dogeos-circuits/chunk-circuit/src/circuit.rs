use openvm::init;
use scroll_zkvm_types_chunk::dogeos::DogeOsChunkWitness;
...
impl Circuit for ChunkCircuit {
    ...
    type PublicInputs = VersionedDogeOsChunkInfo;
    ...
    fn validate(witness: Self::Witness) -> Self::PublicInputs {
        ...
        let chunk_info = DogeOsChunkInfo::try_from(witness).expect("failed to execute chunk");
        (chunk_info, version)
    }
}
