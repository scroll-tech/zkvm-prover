use crate::{BatchHeader, BatchHeaderV8, Bytes48, EnvelopeV8, PayloadV8};
...
pub struct BatchInfoBuilderV8;

impl BatchInfoBuilderV8 {
    ...
    pub fn build(
        ...
        let envelope = EnvelopeV8::from(envelope_bytes.as_slice());
        let payload = PayloadV8::from(&envelope);
