...
use scroll_zkvm_circuit_input_types::{
    AggCircuit, Circuit, ProofCarryingWitness, PublicInputs, batch::ArchivedBatchWitness,
    chunk::ChunkInfo, proof::RootProofWithPublicValues,
};

use crate::{batch::PIBuilder, execute::execute, utils::read_witnesses};
...
impl AggCircuit for BatchCircuit {
    ...
    fn deserialize_prev_pi_hashes(
        proofs: &[RootProofWithPublicValues],
